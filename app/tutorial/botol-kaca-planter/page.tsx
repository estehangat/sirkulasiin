...
export const metadata: Metadata = {
  title: "Tutorial: Planter Self-Watering dari Botol Kaca — SirkulasiIn",
  description:
        ...
        <section className={styles.hero} id="tutorial-hero">
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.heroTitle}>
              Planter Botol Kaca{" "}
              <span className={styles.heroTitleAccent}>Self-Watering</span>
            </h1>
            ...
            <div className={styles.heroMeta}>
              ...
              <span className={styles.metaChip}>
                <ClockIcon className={styles.metaChipIcon} />5 Menit
              </span>
              <span
          ...
          <div className={styles.heroVisual}>
            ...
            <div className={styles.impactCard}>
              ...
              <p className={styles.impactDesc}>
                Saves 0.5kg of glass from the waste stream. That&apos;s enough
                to power a laptop for 2 hours!
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.infoCards}>
          <div className={`${styles.infoCard} ${styles.infoCardGreen}`}>
            <div className={styles.infoCardHeader}>
              <div
                className={`${styles.infoCardIcon} ${styles.infoCardIconGreen}`}
              >
          ...
          <div className={`${styles.infoCard} ${styles.infoCardBrown}`}>
            <div className={styles.infoCardHeader}>
              <div
                className={`${styles.infoCardIcon} ${styles.infoCardIconBrown}`}
              >
                  ...
                  <div className={styles.stepSidebar}>
                    ...
                    <div className={styles.sidebarCard}>
                      ...
                      <div className={styles.altMethods}>
                        <span className={styles.altMethod}>
                          Minyak Kayu Putih
                        </span>
                ...
                <div className={styles.stepContentCard}>
                  <div className={styles.stepTextContent}>
                    ...
                    <p className={styles.stepDesc}>
                      ...
                      tekanan yang konsisten. Metode thermal shock dapat
                      digunakan untuk mendapatkan potongan yang lebih bersih dan
                      presisi.
                    </p>
                  </div>
                  <div className={styles.stepImageWrapper}>
              ...
              <div className={styles.stepBody}>
                ...
                >
                  ...
                  <div className={styles.stepTextContent}>
                    ...
                    <h3 className={styles.stepStepTitle}>Haluskan Tepi Kaca</h3>
                    <p className={styles.stepDesc}>
              ...
              <div className={styles.stepBody}>
                <div className={styles.stepContentCard}>
                  <div className={styles.stepTextContent}>
                    ...
                    <h3 className={styles.stepStepTitle}>Pasang Hydro-Link</h3>
                    <p className={styles.stepDesc}>
                      Selipkan sumbu katun organik melalui leher botol. Sumbu
                      ini akan menyerap air dari reservoir dan menyalurkan
                      kelembaban secara konsisten ke akar tanaman, memastikan
                      tanaman Anda tetap terhidrasi tanpa perawatan berlebih.
                    </p>
                  </div>
                  <div className={styles.stepImageWrapper}>
                    <Image
              ...
              <div className={styles.stepBody}>
                <div className={styles.stepSimple}>
                  ...
                  <p className={styles.stepDesc}>
                    ...
                    pilihan Anda. Isi reservoir air, dan saksikan ekosistem mini
                    self-watering Anda hidup! Pastikan ujung sumbu terendam di
                    air untuk menjaga kelembaban optimal.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={styles.footerInner}>
            <div className={styles.footerBrand}>
              ...
              <p className={styles.footerBrandDesc}>
                Platform AI companion untuk gaya hidup sirkular. Mengubah limbah
